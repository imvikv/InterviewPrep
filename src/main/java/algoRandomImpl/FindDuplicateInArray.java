...
public class FindDuplicateInArray {
	...
	public int repeatedNumber(final List<Integer> a) {
		...
		for(int i=1;i<a.size();i++)
		{
			...
			if(s.contains(temp) && a.indexOf(a.get(i))!=i)
			{	index=i;
				break;
			}
			s+=a.get(i).toString();
